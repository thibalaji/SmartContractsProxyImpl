/**
 * A blockchain solution to service supply chain
 * This implementation is to store and return supply chain parameters
*/
...
function setWorkerName(string memory name) public  payable
{
...
{
	console.log("Inside getworkers list");
    return workers_list;
}

function getProductStatus(uint256 id) public view returns(Status[] memory){
	console.log("Inside get product status list");
